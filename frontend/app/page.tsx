  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-6 text-lg">
              ...
              <li><Button className="text-blue-600">Sign Up</Button></li>
              <li><Button className="text-blue-600">Sign In</Button></li>
            </ul>
          </nav>
        </div>
      </header>
      ...
      <section className="flex-grow flex flex-col items-center justify-center text-center p-8">
        <h2 className="text-5xl font-bold mb-6 text-gray-800">Welcome to Asset Management</h2>
        <p className="text-xl mb-10 text-gray-600">Manage your assets efficiently and effectively with our top-notch solutions.</p>
        <Button className="px-6 py-3 text-lg bg-blue-600 text-white hover:bg-blue-700">Contribute</Button>
      </section>
